...
function SignUpPage() {
  ...
  // All state declared at the top — required by React rules of hooks
  ...
  const handleOAuth = async (strategy: "oauth_google" | "oauth_apple" | "oauth_facebook") => {
    ...
    try {
      ...
      setP1Error(e?.errors?.[0]?.message ?? "OAuth sign-up failed. Try again.");
  ...
  // ── SSO callback — must come after all hooks ──────────────────────────────
  ...
  return (
    ...
    >
      ...
      <div style={{ display: "flex", alignItems: "center", gap: 6, marginBottom: 24 }}>
        {[1, 2, 3].map((n) => (
          <div key={n} style={{
            height: 4, flex: n === phase ? 2 : 1, borderRadius: 99,
      ...
      {phase === 1 && (
        <div style={{ display: "flex", flexDirection: "column", gap: 14 }}>
          ...
          {/* Divider */}
          <div style={{ display: "flex", alignItems: "center", gap: 10 }} className="su-field">
          ...
          <button
            ...
            className="su-field"
            style={{
              animationDelay: "0.3s", width: "100%", padding: "13px 0", borderRadius: 10,
              background: p1Ready && !p1Submitting ? "#f59e0b" : "rgba(245,158,11,0.15)",
              border: "none", color: p1Ready && !p1Submitting ? "#07080a" : "rgba(245,158,11,0.35)",
              fontSize: 14, fontWeight: 700, cursor: p1Ready && !p1Submitting ? "pointer" : "not-allowed",
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 14 }}>
          ...
          <button
            ...
            style={{
              ...
              border: "none", color: code.length === 6 && !verifying ? "#07080a" : "rgba(245,158,11,0.35)",
              fontSize: 14, fontWeight: 700, cursor: code.length === 6 && !verifying ? "pointer" : "not-allowed",
              transition: "all 0.2s",
            }}
          >
